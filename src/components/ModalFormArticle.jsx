...
const ModalFormArticle = () => {
    ...
    const handleSubmit = async e => {
        ...
        await submitArticle({ id, name, quantity, company: params.id})
    ...
    return (
        <Transition.Root show={ modalFormArticle } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalArticle}>
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                        <h1 className='text-4xl'>{id ? 'Editar Articulo' : 'Añadir Articulo'}</h1>
                                    </Dialog.Title>
                                    ...
                                    >
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm' htmlFor='quantity'>
                                                Cantidad 
                                            </label>
                                            <input 
                                                type="text"
                                        ...
                                        <input
                                           ...
                                           value={id ? 'Guardar Cambios' : 'Añadir Articulo'}
